...
urlpatterns = [
    ...
    url(r'^api/test/(?P<id>\d+)/', dashboard.views.api.ScoresAPIView.as_view(), name='test_scores_api'),
    url(r'^api/test/list/', dashboard.views.api.GetTestsAPIView.as_view(), name='featured_tests'),
