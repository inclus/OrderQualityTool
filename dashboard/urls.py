...
urlpatterns = [
    ...
    url(r'^api/test/nnrtiAdults', dashboard.views.api.NNRTIAdultsView.as_view(), name='nnrti_current_adults'),
    url(r'^api/test/nnrtiPaed', dashboard.views.api.NNRTIPaedView.as_view(), name='nnrti_current_paed'),
    ...
    url(r'^api/table/scores/csv/(?P<id>\d+)/(?P<column>\d+$)', csrf_exempt(dashboard.views.tables.ScoreDetailsCSVView.as_view()), name='scores-detail-csv'),
