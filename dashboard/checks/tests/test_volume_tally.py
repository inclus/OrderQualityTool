...
patients_blank = LocationData.migrate_from_dict(
    {
        ...
        C_RECORDS: [{FORMULATION: F1_QUERY, COMBINED_CONSUMPTION: 1000}],
    }
)
...
consumption_blank = LocationData.migrate_from_dict(
    {
        ...
        C_RECORDS: [{FORMULATION: F1_QUERY, COMBINED_CONSUMPTION: None}],
    }
)
...
above_30_percent = LocationData.migrate_from_dict(
    {
        ...
        C_RECORDS: [{FORMULATION: F1_QUERY, COMBINED_CONSUMPTION: 36}],
    }
)
