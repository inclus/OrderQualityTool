...
current_adult_initial = LocationData.migrate_from_dict(
    {
        C_RECORDS: [
            ...
            {COMBINED_CONSUMPTION: 10, FORMULATION: "Efavirenz (EFV) 600mg [Pack 30]"},
            {COMBINED_CONSUMPTION: 10, FORMULATION: "Nevirapine (NVP) 200mg [Pack 60]"},
            {
                COMBINED_CONSUMPTION: 10,
...
current_adult_all_zero = LocationData.migrate_from_dict(
    {
        C_RECORDS: [
            ...
            {COMBINED_CONSUMPTION: 0, FORMULATION: "Efavirenz (EFV) 600mg [Pack 30]"},
            {COMBINED_CONSUMPTION: 0, FORMULATION: "Nevirapine (NVP) 200mg [Pack 60]"},
            {
                COMBINED_CONSUMPTION: 0,
                FORMULATION: "Atazanavir/Ritonavir (ATV/r) 300mg/100mg [Pack 30]",
            },
...
current_adult_2 = LocationData.migrate_from_dict(
    {
        C_RECORDS: [
            ...
            {COMBINED_CONSUMPTION: 5, FORMULATION: "Efavirenz (EFV) 600mg [Pack 30]"},
            {COMBINED_CONSUMPTION: 5, FORMULATION: "Nevirapine (NVP) 200mg [Pack 60]"},
            {
...
current_paed_initial = LocationData.migrate_from_dict(
    {
        C_RECORDS: [
            ...
            {COMBINED_CONSUMPTION: 10, FORMULATION: "Efavirenz (EFV) 200mg [Pack 90]"},
            {COMBINED_CONSUMPTION: 10, FORMULATION: "Nevirapine (NVP) 50mg [Pack 60]"},
            {
                COMBINED_CONSUMPTION: 10,
...
current_paed_all_zero = LocationData.migrate_from_dict(
    {
        C_RECORDS: [
            ...
            {COMBINED_CONSUMPTION: 0, FORMULATION: "Efavirenz (EFV) 200mg [Pack 90]"},
            {COMBINED_CONSUMPTION: 0, FORMULATION: "Nevirapine (NVP) 50mg [Pack 60]"},
            {
                COMBINED_CONSUMPTION: 0,
                FORMULATION: "Lopinavir/Ritonavir (LPV/r) 80mg/20ml oral susp [Bottle 60ml]",
            },
