...
class TaskTestCase(TestCase):
    ...
    def test_should_import_file(self, mocked):
        file_path = os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "fixtures", "new_format.xlsx"
        )
    ...
    def test_should_record_adult_records_for_each_facility(self):
        ...
        report.locs = [location]
        report.ads = {
            location: [PatientRecord.migrate_from_dict({"new": 20, "existing": 12})]
        }
