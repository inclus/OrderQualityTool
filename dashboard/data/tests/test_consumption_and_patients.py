...
both_zero = {
    ...
    C_RECORDS: [
        {FORMULATION: F1_QUERY, ART_CONSUMPTION: 0}
    ]
...
patients_blank = {
    ...
    C_RECORDS: [
        {FORMULATION: F1_QUERY, ART_CONSUMPTION: 1000}
    ]
...
consumption_blank = {
    ...
    C_RECORDS: [
        {FORMULATION: F1_QUERY, ART_CONSUMPTION: None}
    ]
...
point_seven = {
    ...
    C_RECORDS: [
        {FORMULATION: F1_QUERY, ART_CONSUMPTION: 40}
    ]
}
...
one_point_four = {
    ...
    C_RECORDS: [
        {FORMULATION: F1_QUERY, ART_CONSUMPTION: 20}
    ]
}
